...
func Test_run2(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "example", args: args{lines: parsers.SplitByLines(testInput)}, want: 0},
		{name: "live", args: args{lines: parsers.SplitByLines(inputText)}, want: 0},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := run2(tt.args.lines); got != tt.want {
