...
func (pf *Polyfence) Inside(pt geometry.Point2) bool {
...
func calculateWindingNumber(p Polygon, pt geometry.Point2) int {
...
func isLeft(lineA geometry.Point2, lineB geometry.Point2, pt geometry.Point2) int {
